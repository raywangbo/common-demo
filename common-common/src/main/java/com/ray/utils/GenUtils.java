...
import com.quantuStar.core.entity.ColumnEntity;
import com.quantuStar.core.entity.TableEntity;
...
public class GenUtils
{
     ...
     * @throws Exception
     */
    public static void generatorCode(Map table, List<Map> columns, ZipOutputStream zip) throws Exception
    {
        // 配置信息
